namespace Altalents.MVC.Constantes
{
    public static class RedirectionConstantes
    {
        ...
        public static string MdpOubliePage => "~/" + RoutesNamesConstantes.MvcAreaAdmin + "/" + RoutesNamesConstantes.MvcControllerAccount + "/" + RoutesNamesConstantes.MvcControllerAccount_MethodeMdpOubliePage;
    }
}
