...
.OnDelete(DeleteBehavior.NoAction);
 ...
 Code=Commun.Enums.CodeReferenceEnum.MarketingDigital.ToString("g"),
            ...
            #region Outils 
             ...
             #region Domaines 
new () { Libelle = "Activités Juridiques Et Comptables", Id = Guid.Parse("e37ab257-7c00-4a8a-b71f-681ad18d1de2"), DateCrea = new DateTime(2024,11,20), UtiCrea = "ALTEA", IsValide = true, Type = Commun.Enums.TypeReferenceEnum.Domaine, OrdreTri = 1, Code = Commun.Enums.CodeReferenceEnum.ActivitesJuridiquesEtComptables.ToString("g") },
new () { Libelle = "Agriculture Et Élevage", Id = Guid.Parse("21d2b28e-9d36-4d4d-8f01-f62d0ea149ef"), DateCrea = new DateTime(2024,11,20), UtiCrea = "ALTEA", IsValide = true, Type = Commun.Enums.TypeReferenceEnum.Domaine, OrdreTri = 1, Code = Commun.Enums.CodeReferenceEnum.AgricultureEtElevage.ToString("g") },
new () { Libelle = "Architecture Études Et Normes", Id = Guid.Parse("650e788b-86b9-4884-a4eb-3582eb4f1d0d"), DateCrea =new DateTime(2024,11,20), UtiCrea = "ALTEA", IsValide = true, Type = Commun.Enums.TypeReferenceEnum.Domaine, OrdreTri = 1, Code = Commun.Enums.CodeReferenceEnum.ArchitectureEtudesEtNormes.ToString("g") },
new () { Libelle = "Art Audiovisuel Et Spectacle", Id = Guid.Parse("95b23bbb-a76b-4ed5-ba30-0ff4c1eb8870"), DateCrea = new DateTime(2024,11,20), UtiCrea = "ALTEA", IsValide = true, Type = Commun.Enums.TypeReferenceEnum.Domaine, OrdreTri = 1, Code = Commun.Enums.CodeReferenceEnum.ArtAudiovisuelEtSpectacle.ToString("g") },
new () { Libelle = "Automobile", Id = Guid.Parse("89810245-c71d-4772-b648-3fa7b626ea69"), DateCrea = new DateTime(2024,11,20), UtiCrea = "ALTEA", IsValide = true, Type = Commun.Enums.TypeReferenceEnum.Domaine, OrdreTri = 1, Code = Commun.Enums.CodeReferenceEnum.Automobile.ToString("g") },
new () { Libelle = "Bâtiment Et Travaux Publics", Id = Guid.Parse("5557465c-07ad-4ffe-85e3-bf8c2c34a07f"), DateCrea = new DateTime(2024,11,20), UtiCrea = "ALTEA", IsValide = true, Type = Commun.Enums.TypeReferenceEnum.Domaine, OrdreTri = 1, Code = Commun.Enums.CodeReferenceEnum.BatimentEtTravauxPublic.ToString("g") },
new () { Libelle = "Commerce Et Distribution", Id = Guid.Parse("4055b77d-03a0-44f8-84dd-926fdb07f568"), DateCrea = new DateTime(2024,11,20), UtiCrea = "ALTEA", IsValide = true, Type = Commun.Enums.TypeReferenceEnum.Domaine, OrdreTri = 1, Code = Commun.Enums.CodeReferenceEnum.CommerceEtDistribution.ToString("g") },
new () { Libelle = "Communication Et Marketing", Id = Guid.Parse("babdff53-7380-48df-81ca-30e6da210010"), DateCrea = new DateTime(2024,11,20), UtiCrea = "ALTEA", IsValide = true, Type = Commun.Enums.TypeReferenceEnum.Domaine, OrdreTri = 1, Code = Commun.Enums.CodeReferenceEnum.CommunicationMarketing.ToString("g") },
new () { Libelle = "Culture Et Patrimoine", Id = Guid.Parse("f05c980c-fd2d-454c-81d9-9afaa2f4b822"), DateCrea = new DateTime(2024,11,20), UtiCrea = "ALTEA", IsValide = true, Type = Commun.Enums.TypeReferenceEnum.Domaine, OrdreTri = 1, Code = Commun.Enums.CodeReferenceEnum.CulturePatrimoine.ToString("g") },
new () { Libelle = "Édition", Id = Guid.Parse("c24eefc2-f4ba-463b-88fa-dca5f83e9d6f"), DateCrea = new DateTime(2024,11,20), UtiCrea = "ALTEA", IsValide = true, Type = Commun.Enums.TypeReferenceEnum.Domaine, OrdreTri = 1, Code = Commun.Enums.CodeReferenceEnum.Edition.ToString("g") },
...
new () { Libelle = "Enseignement Et Formation", Id = Guid.Parse("413c2810-d35c-4164-9021-73f5e50bad2b"), DateCrea = new DateTime(2024,11,20), UtiCrea = "ALTEA", IsValide = true, Type = Commun.Enums.TypeReferenceEnum.Domaine, OrdreTri = 1, Code = Commun.Enums.CodeReferenceEnum.EnseignementEtFormation.ToString("g") },
...
new () { Libelle = "Finance Banque Et Assurance", Id = Guid.Parse("7b41cb52-4dbe-451e-bf7c-51d01a04e7e9"), DateCrea = new DateTime(2024,11,20), UtiCrea = "ALTEA", IsValide = true, Type = Commun.Enums.TypeReferenceEnum.Domaine, OrdreTri = 1, Code = Commun.Enums.CodeReferenceEnum.FinanceBanqueEtAssurance.ToString("g") },
new () { Libelle = "Gestion Administrative Et Ressources Humaines", Id = Guid.Parse("bc9e9fa2-b46a-4974-9961-8814be2aa9f5"), DateCrea = new DateTime(2024,11,20), UtiCrea = "ALTEA", IsValide = true, Type = Commun.Enums.TypeReferenceEnum.Domaine, OrdreTri = 1, Code = Commun.Enums.CodeReferenceEnum.GestionAdministrativeEtRessourcesHumaine.ToString("g") },
new () { Libelle = "Hôtellerie Et Restauration", Id = Guid.Parse("8c479024-2491-4d30-99bf-c2d0948d36e6"), DateCrea = new DateTime(2024,11,20), UtiCrea = "ALTEA", IsValide = true, Type = Commun.Enums.TypeReferenceEnum.Domaine, OrdreTri = 1, Code = Commun.Enums.CodeReferenceEnum.HotellerieEtRestauration.ToString("g") },
...
new () { Libelle = "Informatique Et Télécommunication", Id = Guid.Parse("939d7426-2069-4100-a8db-5ec86082fd49"), DateCrea = new DateTime(2024,11,20), UtiCrea = "ALTEA", IsValide = true, Type = Commun.Enums.TypeReferenceEnum.Domaine, OrdreTri = 1, Code = Commun.Enums.CodeReferenceEnum.InformatiqueEtTelecommunication.ToString("g") },
new () { Libelle = "Logistique Et Transport", Id = Guid.Parse("93123d1d-aa63-4e9a-b89c-72db6e616f76"), DateCrea = new DateTime(2024,11,20), UtiCrea = "ALTEA", IsValide = true, Type = Commun.Enums.TypeReferenceEnum.Domaine, OrdreTri = 1, Code = Commun.Enums.CodeReferenceEnum.LogistiqueEtTransport.ToString("g") },
new () { Libelle = "Maintenance Entretien Et Nettoyage", Id = Guid.Parse("74536288-8a56-4ab1-9410-e9203bbaa60d"), DateCrea = new DateTime(2024,11,20), UtiCrea = "ALTEA", IsValide = true, Type = Commun.Enums.TypeReferenceEnum.Domaine, OrdreTri = 1, Code = Commun.Enums.CodeReferenceEnum.MaintenanceEntretienEtNotoyage.ToString("g") },
...
new () { Libelle = "Santé", Id = Guid.Parse("53f64464-3ac1-4440-9cbe-c629c0244ec7"), DateCrea = new DateTime(2024,11,20), UtiCrea = "ALTEA", IsValide = true, Type = Commun.Enums.TypeReferenceEnum.Domaine, OrdreTri = 1, Code = Commun.Enums.CodeReferenceEnum.Santé.ToString("g") },
new () { Libelle = "Service À La Personne", Id = Guid.Parse("804109be-d3de-4745-a8aa-e6535e1c3151"), DateCrea = new DateTime(2024,11,20), UtiCrea = "ALTEA", IsValide = true, Type = Commun.Enums.TypeReferenceEnum.Domaine, OrdreTri = 1, Code = Commun.Enums.CodeReferenceEnum.ServiceALaPersonne.ToString("g") },
new () { Libelle = "Service Public Défense Et Sécurité", Id = Guid.Parse("85e06dc8-abe0-4eb7-85df-c8f67d2f2cca"), DateCrea = new DateTime(2024,11,20), UtiCrea = "ALTEA", IsValide = true, Type = Commun.Enums.TypeReferenceEnum.Domaine, OrdreTri = 1, Code = Commun.Enums.CodeReferenceEnum.ServicePublicDefenseSecurite.ToString("g") },
...
new () { Libelle = "Sport, Animation Et Loisir", Id = Guid.Parse("f5f43903-c3f7-47fd-a207-98887dd59e87"), DateCrea = new DateTime(2024,11,20), UtiCrea = "ALTEA", IsValide = true, Type = Commun.Enums.TypeReferenceEnum.Domaine, OrdreTri = 1, Code = Commun.Enums.CodeReferenceEnum.SportAnimationLoisir.ToString("g") },
new () { Libelle = "Tourisme", Id = Guid.Parse("41a511c4-eac4-4411-9fcc-2dad63333206"), DateCrea = new DateTime(2024,11,20), UtiCrea = "ALTEA", IsValide = true, Type = Commun.Enums.TypeReferenceEnum.Domaine, OrdreTri = 1, Code = Commun.Enums.CodeReferenceEnum.Tourismne.ToString("g") },
new () { Libelle = "Autre", Id = Guid.Parse(IdsConstantes.DomaineAutreId), DateCrea = new DateTime(2024,11,20), UtiCrea = "ALTEA", IsValide = true, Type = Commun.Enums.TypeReferenceEnum.Domaine, OrdreTri = 1, Code = Commun.Enums.CodeReferenceEnum.Tourismne.ToString("g") }
